...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/app/dashboard/manager/components/ui/select"
import { Button } from "@/app/dashboard/manager/components/ui/button"
import { Card, CardContent } from "@/app/dashboard/manager/components/ui/card"  
...
export function PayslipHistory({ onOpenPayslip }: PayslipHistoryProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8"> {/* Added more bottom margin */}
        <div>
          ...
          <Select value={selectedYear} onValueChange={setSelectedYear}>
            ...
            <SelectContent className="z-50"> {/* Added z-index */}
